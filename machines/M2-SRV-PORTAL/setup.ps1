# M2-SRV-PORTAL Setup Script — Operation PHANTOM RELAY (GRIDFALL)
# Run as Administrator on the target machine

Write-Host "[*] Starting M2-SRV-PORTAL configuration..." -ForegroundColor Cyan
...
Write-Host "[+] M2-SRV-PORTAL base configuration complete" -ForegroundColor Green
