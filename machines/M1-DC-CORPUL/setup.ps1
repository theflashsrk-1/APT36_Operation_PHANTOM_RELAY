# M1-DC-CORPUL Setup Script — Operation PHANTOM RELAY (GRIDFALL)
# Run as Administrator on the target machine

Write-Host "[*] Starting M1-DC-CORPUL configuration..." -ForegroundColor Cyan
...
Write-Host "[+] M1-DC-CORPUL base configuration complete" -ForegroundColor Green
